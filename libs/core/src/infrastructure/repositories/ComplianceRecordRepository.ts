        ...
        export class ComplianceRecordRepository implements IComplianceRecordRepository {
            ...
            async getComplianceRecord(params: IRepositoryParams<QueryComplianceRecordArgs>): Promise<ComplianceRecord | null> {
...
last_checked_date
                ...
                })?.then((response) => response.complianceRecord)?.catch(() => null);
            }

            async getComplianceRecordsList(params: IRepositoryParams<QueryComplianceRecordsListArgs>): Promise<ComplianceRecordListResponse> {
                return this.http.requestGraphQL<{
...
last_checked_date
                ...
                ?.then((response) => response.complianceRecordsList);
                    ...
                    async createComplianceRecord(params: IRepositoryParams<MutationComplianceRecordCreateArgs>): Promise<ComplianceRecord | null> {
                        return this.http.requestGraphQL<{
                          complianceRecordCreate: ComplianceRecord
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.complianceRecordCreate)?.catch(() => null);
                  }
                

                    async deleteComplianceRecord(params: IRepositoryParams<MutationComplianceRecordDeleteArgs>): Promise<SuccessResponse | null> {
                    ...
                    async updateComplianceRecord(params: IRepositoryParams<MutationComplianceRecordUpdateArgs>): Promise<ComplianceRecord | null> {
                        return this.http.requestGraphQL<{
                          complianceRecordUpdate: ComplianceRecord
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.complianceRecordUpdate)?.catch(() => null);
                  }
