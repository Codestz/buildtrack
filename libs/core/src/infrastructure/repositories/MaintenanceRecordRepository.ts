        ...
        export class MaintenanceRecordRepository implements IMaintenanceRecordRepository {
            ...
            async getMaintenanceRecord(params: IRepositoryParams<QueryMaintenanceRecordArgs>): Promise<MaintenanceRecord | null> {
...
date
                ...
                })?.then((response) => response.maintenanceRecord)?.catch(() => null);
            }

            async getMaintenanceRecordsList(params: IRepositoryParams<QueryMaintenanceRecordsListArgs>): Promise<MaintenanceRecordListResponse> {
                return this.http.requestGraphQL<{
...
date
                ...
                ?.then((response) => response.maintenanceRecordsList);
                    ...
                    async createMaintenanceRecord(params: IRepositoryParams<MutationMaintenanceRecordCreateArgs>): Promise<MaintenanceRecord | null> {
                        return this.http.requestGraphQL<{
                          maintenanceRecordCreate: MaintenanceRecord
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.maintenanceRecordCreate)?.catch(() => null);
                  }
                

                    async deleteMaintenanceRecord(params: IRepositoryParams<MutationMaintenanceRecordDeleteArgs>): Promise<SuccessResponse | null> {
                    ...
                    async updateMaintenanceRecord(params: IRepositoryParams<MutationMaintenanceRecordUpdateArgs>): Promise<MaintenanceRecord | null> {
                        return this.http.requestGraphQL<{
                          maintenanceRecordUpdate: MaintenanceRecord
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.maintenanceRecordUpdate)?.catch(() => null);
                  }
