        ...
        export class ImprovementRepository implements IImprovementRepository {
            ...
            async getImprovement(params: IRepositoryParams<QueryImprovementArgs>): Promise<Improvement | null> {
...
cost
                ...
                })?.then((response) => response.improvement)?.catch(() => null);
            }

            async getImprovementsList(params: IRepositoryParams<QueryImprovementsListArgs>): Promise<ImprovementListResponse> {
                return this.http.requestGraphQL<{
...
cost
                ...
                ?.then((response) => response.improvementsList);
                    ...
                    async createImprovement(params: IRepositoryParams<MutationImprovementCreateArgs>): Promise<Improvement | null> {
                        return this.http.requestGraphQL<{
                          improvementCreate: Improvement
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.improvementCreate)?.catch(() => null);
                  }
                

                    async deleteImprovement(params: IRepositoryParams<MutationImprovementDeleteArgs>): Promise<SuccessResponse | null> {
                    ...
                    async updateImprovement(params: IRepositoryParams<MutationImprovementUpdateArgs>): Promise<Improvement | null> {
                        return this.http.requestGraphQL<{
                          improvementUpdate: Improvement
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.improvementUpdate)?.catch(() => null);
                  }
