        ...
        export class EnergyEfficiencyRepository implements IEnergyEfficiencyRepository {
            ...
            async getEnergyEfficiency(params: IRepositoryParams<QueryEnergyEfficiencyArgs>): Promise<EnergyEfficiency | null> {
...
energy_savings
                ...
                })?.then((response) => response.energyEfficiency)?.catch(() => null);
            }

            async getEnergyEfficiencyList(params: IRepositoryParams<QueryEnergyEfficienciesListArgs>): Promise<EnergyEfficiencyListResponse> {
                return this.http.requestGraphQL<{
...
energy_savings
                ...
                ?.then((response) => response.energyEfficienciesList);
                    ...
                    async createEnergyEfficiency(params: IRepositoryParams<MutationEnergyEfficiencyCreateArgs>): Promise<EnergyEfficiency | null> {
                        return this.http.requestGraphQL<{
                          energyEfficiencyCreate: EnergyEfficiency
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.energyEfficiencyCreate)?.catch(() => null);
                  }
                

                    async deleteEnergyEfficiency(params: IRepositoryParams<MutationEnergyEfficiencyDeleteArgs>): Promise<SuccessResponse | null> {
                    ...
                    async updateEnergyEfficiency(params: IRepositoryParams<MutationEnergyEfficiencyUpdateArgs>): Promise<EnergyEfficiency | null> {
                        return this.http.requestGraphQL<{
                          energyEfficiencyUpdate: EnergyEfficiency
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.energyEfficiencyUpdate)?.catch(() => null);
                  }
