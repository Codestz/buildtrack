        ...
        export class WorkOrderRepository implements IWorkOrderRepository {
            ...
            async getWorkOrder(params: IRepositoryParams<QueryWorkOrderArgs>): Promise<WorkOrder | null> {
...
status
                ...
                })?.then((response) => response.workOrder)?.catch(() => null);
            }

            async getWorkOrdersList(params: IRepositoryParams<QueryWorkOrdersListArgs>): Promise<WorkOrderListResponse> {
                return this.http.requestGraphQL<{
...
status
                ...
                ?.then((response) => response.workOrdersList);
                    ...
                    async createWorkOrder(params: IRepositoryParams<MutationWorkOrderCreateArgs>): Promise<WorkOrder | null> {
                        return this.http.requestGraphQL<{
                          workOrderCreate: WorkOrder
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.workOrderCreate)?.catch(() => null);
                  }
                

                    async deleteWorkOrder(params: IRepositoryParams<MutationWorkOrderDeleteArgs>): Promise<SuccessResponse | null> {
                    ...
                    async updateWorkOrder(params: IRepositoryParams<MutationWorkOrderUpdateArgs>): Promise<WorkOrder | null> {
                        return this.http.requestGraphQL<{
                          workOrderUpdate: WorkOrder
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.workOrderUpdate)?.catch(() => null);
                  }
