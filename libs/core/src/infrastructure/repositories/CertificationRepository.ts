        ...
        export class CertificationRepository implements ICertificationRepository {
            ...
            async getCertification(params: IRepositoryParams<QueryCertificationArgs>): Promise<Certification | null> {
...
expiry_date
                ...
                })?.then((response) => response.certification)?.catch(() => null);
            }

            async getCertificationsList(params: IRepositoryParams<QueryCertificationsListArgs>): Promise<CertificationListResponse> {
                return this.http.requestGraphQL<{
...
expiry_date
                ...
                ?.then((response) => response.certificationsList);
                    ...
                    async createCertification(params: IRepositoryParams<MutationCertificationCreateArgs>): Promise<Certification | null> {
                        return this.http.requestGraphQL<{
                          certificationCreate: Certification
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.certificationCreate)?.catch(() => null);
                  }
                

                    async deleteCertification(params: IRepositoryParams<MutationCertificationDeleteArgs>): Promise<SuccessResponse | null> {
                    ...
                    async updateCertification(params: IRepositoryParams<MutationCertificationUpdateArgs>): Promise<Certification | null> {
                        return this.http.requestGraphQL<{
                          certificationUpdate: Certification
                            ...
                            token: params.token,
                            variables: params.variables,
                        })?.then((response) => response.certificationUpdate)?.catch(() => null);
                  }
