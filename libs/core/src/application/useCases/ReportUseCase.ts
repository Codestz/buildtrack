        ...
        import {IReportRepository, ReportRepository, IRepositoryParams} from '../../infrastructure';
        ...
        export class ReportUseCase implements IReportUseCase {
            ...
            async getReport(params: IRepositoryParams<QueryReportArgs>): Promise<ReportEntity | null> {
                        try {
                            return this.repository.getReport(params)
            ...
            async getReportList(params: IRepositoryParams<QueryReportsListArgs>): Promise<{
                count: number;
                items: Array<ReportEntity>;
                }> {
                try {
                    return this.repository.getReportsList(params)
                    .then((result) => {
                        return {
                    ...
                    .catch((err) => this.errorCatcher(err, 'getReportsList'));
                } catch (error) {
                    this.errorCatcher(error, 'getReportsList');
                }
            }

            async createReport(params: IRepositoryParams<MutationReportCreateArgs>): Promise<boolean> {
                        try {
                            return this.repository.createReport(params)
                    ...
                    async deleteReport(params: IRepositoryParams<MutationReportDeleteArgs>): Promise<boolean> {
                        try {
                            return this.repository.deleteReport(params)
...
async updateReport(params: IRepositoryParams<MutationReportUpdateArgs>): Promise<boolean> {
                        try {
                            return this.repository.updateReport(params)
                            .then((result) => !!result?.id)
