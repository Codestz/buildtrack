        ...
        import {IPermitRepository, PermitRepository, IRepositoryParams} from '../../infrastructure';
        ...
        export class PermitUseCase implements IPermitUseCase {
            ...
            async getPermit(params: IRepositoryParams<QueryPermitArgs>): Promise<PermitEntity | null> {
                        try {
                            return this.repository.getPermit(params)
            ...
            async getPermitList(params: IRepositoryParams<QueryPermitsListArgs>): Promise<{
                count: number;
                items: Array<PermitEntity>;
                }> {
                try {
                    return this.repository.getPermitsList(params)
                    .then((result) => {
                        return {
                    ...
                    .catch((err) => this.errorCatcher(err, 'getPermitsList'));
                } catch (error) {
                    this.errorCatcher(error, 'getPermitsList');
                }
            }

            async createPermit(params: IRepositoryParams<MutationPermitCreateArgs>): Promise<boolean> {
                        try {
                            return this.repository.createPermit(params)
                    ...
                    async deletePermit(params: IRepositoryParams<MutationPermitDeleteArgs>): Promise<boolean> {
                        try {
                            return this.repository.deletePermit(params)
...
async updatePermit(params: IRepositoryParams<MutationPermitUpdateArgs>): Promise<boolean> {
                        try {
                            return this.repository.updatePermit(params)
                            .then((result) => !!result?.id)
