...
Date?: string;
           ...
           /** 
             * Type: QueryMaintenanceRecordsListArgs
            {
 ...
 * 
           ...
           * 
           * @param {QueryMaintenanceRecordsListArgs} variables - The query variables.
          */

          export function useMaintenanceRecordList(
              variables?: QueryMaintenanceRecordsListArgs,
        ) {
          ...
          } | null>(
          {
              ...
              queryFn: async () => UseCases.MaintenanceRecord.getMaintenanceRecordList({
                variables: variables || {},
