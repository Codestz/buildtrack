 ...
 * 
          ...
          /**
           * Hook to fetch list of Document from the server.
           * 
           * @returns {UseQueryResult<{items: DocumentEntity[], count: number} | null>}
           * 
           * @example
           * const {data, isError, isLoading, isFetching, refetch} = useDocumentList({first: 10});
           * 
           * @param {QueryDocumentsListArgs} variables - The query variables.
          */

          export function useDocumentList(
              variables?: QueryDocumentsListArgs,
        ) {
          ...
          } | null>(
          {
              ...
              queryFn: async () => UseCases.Document.getDocumentList({
                variables: variables || {},
